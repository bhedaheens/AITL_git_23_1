...
public class PickConfig {
    ...
    public final static String EXTRA_FLAG = "fragment_flag";
    ...
    private PickConfig(Activity context,PickConfig.Builder builder){
        ...
        this.flagMode = builder.flagMode;
        ...
        bundle.putInt(EXTRA_FLAG, this.flagMode);
    ...
    public static class Builder{
        ...
        private int flagMode = FLAG_MODE;
        ...
        public PickConfig.Builder flag(int flagMode) {
            this.flagMode = flagMode;
            if (this.flagMode == 0) {
                this.flagMode = FLAG_MODE;
            }
            return this;
        }
