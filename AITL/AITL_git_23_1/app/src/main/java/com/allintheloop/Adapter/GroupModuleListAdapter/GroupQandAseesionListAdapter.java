...
public class GroupQandAseesionListAdapter extends RecyclerView.Adapter<GroupQandAseesionListAdapter.ViewHolder> implements Filterable {
    ...
    public GroupQandAseesionListAdapter(ArrayList<GroupModuleData> groupModuleDataArrayList, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int i) {
        ...
        holder.app_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sessionManager.setQandAgroupID(moduleDataObj.getModuleGroupId());
    ...
    private static class GtroupFilter extends Filter {
        private final GroupQandAseesionListAdapter grouoQandAseesionListAdapter;
        ...
        public GtroupFilter(GroupQandAseesionListAdapter grouoQandAseesionListAdapter, ArrayList<GroupModuleData> groupModuleDataArrayList) {
