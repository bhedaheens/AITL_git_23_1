...
public class GroupAgendaListAdapter extends RecyclerView.Adapter<GroupAgendaListAdapter.ViewHolder> implements Filterable {
    ...
    public GroupAgendaListAdapter(ArrayList<GroupModuleData> groupModuleDataArrayList, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int i) {
        ...
        holder.app_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sessionManager.setAgendagroupID(moduleDataObj.getModuleGroupId());
    ...
    public Filter getFilter() {
        return new GroupAgendaListAdapter.GtroupFilter(this, groupModuleDataArrayList);
    }

    private static class GtroupFilter extends Filter {
        private final GroupAgendaListAdapter groupMapListAdapter;
        ...
        public GtroupFilter(GroupAgendaListAdapter groupMapListAdapter, ArrayList<GroupModuleData> groupModuleDataArrayList) {
