...
public class MapCoordinatesDetails {
    ...
    String menuid, redirect_url, cmsid, is_force_login, agenda_id, group_id, exhi_id, super_group_id, exhi_sub_cat_id, all_exhi_sub_cat, is_contains_data, is_user_agenda;

    public MapCoordinatesDetails(Rect rect, String rectHeading) {
        this.rect = rect;
        this.rectHeading = rectHeading;
    }

    public MapCoordinatesDetails(Rect rect, String rectHeading, String menuid, String redirect_url, String cmsid, String is_force_login, String agenda_id, String group_id, String exhi_id, String super_group_id, String exhi_sub_cat_id, String all_exhi_sub_cat, String is_contains_data, String is_user_agenda) {
        this.rect = rect;
        this.rectHeading = rectHeading;
        this.menuid = menuid;
    ...
    public void setRectHeading(String rectHeading) {
        this.rectHeading = rectHeading;
    }
}
