...
public class GroupSponsorListAdapter extends RecyclerView.Adapter<GroupSponsorListAdapter.ViewHolder> implements Filterable {
    ...
    public GroupSponsorListAdapter(ArrayList<GroupModuleData> groupModuleDataArrayList, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int i) {
        ...
        holder.app_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sessionManager.setSponsorPrentGroupID(moduleDataObj.getModuleGroupId());
    ...
    public Filter getFilter() {
        return new GroupSponsorListAdapter.GtroupFilter(this, groupModuleDataArrayList);
    }
    ...
    private static class GtroupFilter extends Filter {
        ...
        public GtroupFilter(GroupSponsorListAdapter groupMapListAdapter, ArrayList<GroupModuleData> groupModuleDataArrayList) {
