...
public class CMSMainGroupListAdapter extends RecyclerView.Adapter<CMSMainGroupListAdapter.ViewHolder> implements Filterable {

    ArrayList<SuperGroupData> groupModuleDataArrayList;
    ArrayList<SuperGroupData> tmp_groupModuleDataArrayList;
    Context context;
    SessionManager sessionManager;

    public CMSMainGroupListAdapter(ArrayList<SuperGroupData> groupModuleDataArrayList, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int i) {
        final SuperGroupData moduleDataObj = tmp_groupModuleDataArrayList.get(i);
        ...
        holder.app_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sessionManager.setCmsSuperGroupId(moduleDataObj.getId());
    ...
    private static class GtroupFilter extends Filter {
        private final CMSMainGroupListAdapter grouoQandAseesionListAdapter;
        private final ArrayList<SuperGroupData> groupModuleDataArrayList;
        private final ArrayList<SuperGroupData> tmpgroupModuleDataArrayList;

        public GtroupFilter(CMSMainGroupListAdapter grouoQandAseesionListAdapter, ArrayList<SuperGroupData> groupModuleDataArrayList) {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint.length() <= 0) {
                ...
                for (SuperGroupData attenObj : groupModuleDataArrayList) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            grouoQandAseesionListAdapter.tmp_groupModuleDataArrayList.addAll((ArrayList<SuperGroupData>) results.values);
