...
import com.allintheloop.Fragment.AgendaModule.AgendaInstantFragment;
...
public class AgendaTimeAdapter extends FragmentPagerAdapter {
    ...
    public AgendaTimeAdapter(FragmentManager fm, ArrayList<String> timeList, HashMap<String, ArrayList<Agenda_Time>> listDataChild) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        return AgendaInstantFragment.newInstance(agenda_times);
    }
